...
# OPSW_GW_ADDR=84.225.75.1:3001,84.225.75.2:3001 defaults / MSA
# ************************************************************
#
#  ************************************************************
...
INSTALL_LOG="/opt/IBM/ITM/tmp/opsware-agent-linux/sa_agent_install.log"
INSTALL_PATH="/opt/IBM/ITM/tmp/opsware-agent-linux/"
INSTALL_WORK="/opt/IBM/ITM/tmp/"
