...
def f_help_error():
    ...
    print('\t\t\t ITMAgentInstall_UNinstall_windows.cmd -nodename kmdwinitm001 -u      ( uninstall )')
    print('\t\t\t ITMAgentInstall_UNinstall_windows.cmd -nodename kmdwinitm001 -f -u -d   ( uninstall only. )')
    print(" ")
    print(" ")
    exit()
# ----------------------------------------------------------------------------------------------------------------------------------------------------------
