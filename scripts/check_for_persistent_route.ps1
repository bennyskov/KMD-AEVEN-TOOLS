...
"------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
write-host "date:               : $begin"
write-host "hostname:           : $hostname"
write-host "is it x64:          : $x64"
write-host "hostIp:             : $hostIp"
write-host "Powershell ver:     : $psvers"
...
write-host "diskspace: (json)   : $volume"
write-host "Persistent:         : $Persistent"
write-host "persistentRoutes:   : $persistentRoutes"
"------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
